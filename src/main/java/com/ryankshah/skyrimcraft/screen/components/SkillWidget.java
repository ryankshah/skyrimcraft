...
public class SkillWidget extends AbstractWidget implements Renderable
{
    ...
    protected final SkillWidget.OnPress onPress;
    ...
    public SkillWidget(
            Font pFont, int pX, int pY, int pWidth, int pHeight, Component pMessage, List<Skill> skillsList, Skill skill, int currentSkill, SkillWidget.OnPress pOnPress
    ) {
