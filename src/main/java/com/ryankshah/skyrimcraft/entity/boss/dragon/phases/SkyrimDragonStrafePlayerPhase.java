...
public class SkyrimDragonStrafePlayerPhase extends AbstractSkyrimDragonPhaseInstance {
    ...
    public SkyrimDragonStrafePlayerPhase(SkyrimDragon pDragon) {
        super(pDragon);
    }
            ...
            if (this.attackTarget.distanceToSqr(this.dragon) < 4096.0) {
                if (this.dragon.hasLineOfSight(this.attackTarget)) {
                    ...
                    if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                        ...
                        Vec3 vec33 = this.dragon.getHeadLookVector(1.0F);
                        double d6 = vec33.x - vec32.x * 1.0;
                        double d7 = vec33.y + 0.5;
                        double d8 = vec33.z - vec32.z * 1.0;
...
//            }
    ...
    @Override
    public SkyrimDragonPhase<SkyrimDragonStrafePlayerPhase> getPhase() {
        return SkyrimDragonPhase.STRAFE_PLAYER;
    }
}
