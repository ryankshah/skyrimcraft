...
public class MonarchButterfly extends PathfinderMob implements GeoEntity
{
    ...
    private <E extends MonarchButterfly> PlayState butterflyController(final software.bernie.geckolib.core.animation.AnimationState<MonarchButterfly> event) {
    ...
    public void registerControllers(final AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, "monarch_butterfly_controller", 0, this::butterflyController));
    }
}
