...
public class ShoutWallStructures extends Structure {
    ...
    public static final Codec<ShoutWallStructures> CODEC = RecordCodecBuilder.<ShoutWallStructures>mapCodec(instance ->
    ...
    public ShoutWallStructures(Structure.StructureSettings config,
