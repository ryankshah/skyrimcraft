...
public class DungeonStructures extends Structure {
    ...
    public static final Codec<DungeonStructures> CODEC = RecordCodecBuilder.<DungeonStructures>mapCodec(instance ->
    ...
    public StructureType<?> type() {
        return StructureInit.DUNGEON.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}