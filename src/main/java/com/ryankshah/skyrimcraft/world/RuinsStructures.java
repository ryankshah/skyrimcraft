...
public class RuinsStructures extends Structure {
    ...
    public static final Codec<RuinsStructures> CODEC = RecordCodecBuilder.<RuinsStructures>mapCodec(instance ->
    ...
    public StructureType<?> type() {
        return StructureInit.RUINS.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}