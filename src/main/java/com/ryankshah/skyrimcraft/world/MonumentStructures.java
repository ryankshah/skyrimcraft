...
public class MonumentStructures extends Structure {
    ...
    public static final Codec<MonumentStructures> CODEC = RecordCodecBuilder.<MonumentStructures>mapCodec(instance ->
    ...
    public StructureType<?> type() {
        return StructureInit.MONUMENTS.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}