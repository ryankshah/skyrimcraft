...
public class WatchtowerStructures extends Structure {
    ...
    public static final Codec<WatchtowerStructures> CODEC = RecordCodecBuilder.<WatchtowerStructures>mapCodec(instance ->
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        Optional<GenerationStub> structurePiecesGenerator =
                JigsawPlacement.addPieces(
                        ...
                        this.maxDistanceFromCenter, PoolAliasLookup.EMPTY); // Maximum limit for how far pieces can spawn from center. You cannot set this bigger than 128 or else pieces gets cutoff.
    ...
    public StructureType<?> type() {
        return StructureInit.WATCHTOWER.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}