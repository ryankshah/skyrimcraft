...
public class SkillBook extends Item
{
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (this.skill != null) {
            ...
            double xp = skill.get().getXpProgress() / skill.get().getXpNeededForNextLevel();
            ...
            playerIn.displayClientMessage(Component.translatable("skillbook.learn", Component.translatable(skill.get().getName()).withStyle(ChatFormatting.RED)), false);
