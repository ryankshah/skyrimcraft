...
public class SkyrimcraftProjectile extends Projectile {
    ...
    public SkyrimcraftProjectile(EntityType<? extends Projectile> pType, Level pLevel) {
        super(pType, pLevel);
    }

    public SkyrimcraftProjectile(EntityType<? extends Projectile> pType, Level pLevel, Entity pShooter) {
        super(pType, pLevel);

        this.setOwner(pShooter);
    }

    public SkyrimcraftProjectile(EntityType<? extends Projectile> pType, Level pLevel, Entity pShooter, float power) {
